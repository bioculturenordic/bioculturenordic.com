            ...
            <div className="container mx-auto px-4 flex items-center justify-between">
                ...
                <Link href="/" className="flex flex-col leading-none group">
                    ...
                    <span className="text-[10px] uppercase tracking-[0.2em] text-functional-gray font-medium group-hover:text-accent transition-colors">
                        Natural microbial fermentation
                    </span>
                </Link>

                {/* Desktop Nav */}
                <nav className="hidden md:flex items-center gap-8">
                    <Link href="#solution" className="text-sm font-medium text-functional-gray hover:text-primary transition-colors">Solution</Link>
                    <Link href="#science" className="text-sm font-medium text-functional-gray hover:text-primary transition-colors">Application</Link>
                    <Link href="#fermentation" className="text-sm font-medium text-functional-gray hover:text-primary transition-colors">Fermentation</Link>
